...
// TOKEN DO BOT
define ('TOKEN_BOT', '5296013770:AAGJPj6Pb69ZpN-qFi5sB2ntDwpUFkMfdbU');

// API KEY https://sms-activate.ru/en/api2
define ('KEY_SMS', '84503bd64061808A38708A1f8A0b506c');

// token do mercado pago
define ('ACCESS_TOKEN_MERCADO_PAGO', '6630195245:AAFVLsFrO74yoICAnGCoTBlutzyiXbEnrBQ');
...
define ('ADMS', [6291705937, 6291705937]);

define ('CHAT_ID_NOTIFICACAO', '-1001911084029'); // onde irá as notificações de resgate de saldos (opcional)

define ('GRUPO_ID','-781038494'); // grupo de bot
//define ('GRUPO_ID','-781038494'); // grupo de bot
